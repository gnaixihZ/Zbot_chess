...
def draw_init():
    ...
    draw_text(screen,"打石頭或被石頭打",64,WIDTH/2,HEIGHT/4)
    draw_text(screen,"← →移動 空白鍵發射子彈",22,WIDTH/2,HEIGHT/2)
...
class Rock(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.speedy = random.randrange(2,11)
        self.speedx = random.randrange(-3,4)
        self.total_degree = 0
        self.rot_degree = random.randrange(-3,4)
